...
METHOD_ID = "P1_106g_iq_fusion_text"
SSIM_SIZE = 512
BATCH_SIZE = 16
DINO_SIZE = 224
...
# D106.b — gamma for D106 IQ-feature term, only nonzero for formula
GAMMA_DIQA = {
    "table": 0.0,    # control: hold table at D106.b baseline (no fusion)
    "all": 0.0,
    "text": 0.1,     # D106.g: first IQ fusion on text variant; alpha=0.4 entropy preserved → 0.5 prod_cc + 0.4 entropy + 0.1 D106
    "formula": 0.2,  # control: hold formula at D106.b gamma=0.20 baseline
    "all_no_mask": 0.0,
}[variant]
DIQA_EPS = 1e-6
