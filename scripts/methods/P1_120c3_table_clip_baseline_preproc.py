#!/usr/bin/env python3
"""P1_120c3_table_clip_baseline_preproc: H6.1 — restore baseline CLIP preprocessing for table variant.

H6.1 hypothesis: The H4-series scripts replaced baseline's grayscale+SHARPEN+autocontrast->RGB
preprocessing with raw RGB pass-through, costing -0.010 cc on table specifically
(baseline=0.2775 vs P1_120b=0.2681). Re-applying that preprocessing to the table-CLIP path ONLY
should recover the lost cc.

multi_composite formulas (UNCHANGED from H5.b):
...
METHOD_ID = "P1_120c3_table_clip_baseline_preproc"
SSIM_SIZE = 512
BATCH_SIZE = 16
DINO_SIZE = 224
