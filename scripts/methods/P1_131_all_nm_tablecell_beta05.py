...
METHOD_ID = "P1_131_all_nm_tablecell_beta05"
SSIM_SIZE = 512
BATCH_SIZE = 16
DINO_SIZE = 224
...
BETA_TABLE_CELL = {
    ...
    "text": 0.0,
    "formula": 0.0,
    "all_no_mask": 0.05,  # D131: reduce table_cell β 0.10→0.05, frees weight to DocSim
}[variant]
...
BETA_SSIM = {
    "table": 0.05,     # D128: table SSIM supplement β=0.05 (unexplored axis)
    "all": 0.15,
