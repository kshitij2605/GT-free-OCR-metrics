...
METHOD_ID = "P1_107_table_cell_supplement_all_10"
SSIM_SIZE = 512
BATCH_SIZE = 16
DINO_SIZE = 224
...
DIQA_EPS = 1e-6
# D107: per-table-cell MIN DocSim supplement for all/all_no_mask at β=0.10
BETA_TABLE_CELL = {
    "table": 0.0,
    "all": 0.10,         # 0.60*page_DocSim + 0.30*entropy + 0.10*per_cell_MIN_DocSim
    "text": 0.0,
    "formula": 0.0,
    "all_no_mask": 0.10, # 0.50*page_DocSim + 0.40*entropy + 0.10*per_cell_MIN_DocSim
}[variant]
