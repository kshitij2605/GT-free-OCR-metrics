...
METHOD_ID = "P1_118_haarpsi_variant_specific_beta"
SSIM_SIZE = 512
BATCH_SIZE = 16
DINO_SIZE = 224
...
def _ssim_page_supplement(orig_pil, recon_pil):
    """D118: HaarPSI between RGB pages at SSIM_SIZE (replaces SSIM with Haar wavelet PSI)."""
    og = torch.from_numpy(
    ...
    return float(piq.haarpsi(og, rg, data_range=1.0))
