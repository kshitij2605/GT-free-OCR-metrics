...
METHOD_ID = "P1_107c_beta_table_cell_30"
SSIM_SIZE = 512
BATCH_SIZE = 16
DINO_SIZE = 224
...
DIQA_EPS = 1e-6
# D107c: sweep β=0.30 for all/all_no_mask (from D107b β=0.20 sweep)
BETA_TABLE_CELL = {
    "table": 0.0,
    "all": 0.30,         # 0.40*page_DocSim + 0.30*entropy + 0.30*per_cell_MIN_DocSim
    "text": 0.0,
    "formula": 0.0,
    "all_no_mask": 0.30, # 0.30*page_DocSim + 0.40*entropy + 0.30*per_cell_MIN_DocSim
}[variant]
