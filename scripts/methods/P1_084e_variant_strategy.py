#!/usr/bin/env python3
"""P1_084e: Per-variant cosine strategy selection.

H4.e hypothesis: best-of-both composition.
- variant=table: CLIP cosine ONLY (recovers H4.d's 0.2681 vs H4.c's 0.2500)
- all other variants: 0.5 * DINOv2_vitb14_CLS + 0.5 * OpenCLIP_ViT-B/32 (preserves H4.c's all_no_mask 0.3073)

multi_composite (SSIM/MSE/LPIPS) is UNCHANGED vs baseline.
Output JSON shape unchanged: clip_compare={"clip_cosine": <cosine>}.
"""
...
METHOD_ID = "P1_084e_variant_strategy"
SSIM_SIZE = 512
BATCH_SIZE = 16
DINO_SIZE = 224
...
# Per-variant strategy: table uses CLIP-only; all others use 50/50 CLIP+DINOv2 average.
