#!/usr/bin/env python3
"""P1_120b_adists_variant_conditional: Variant-conditional multi_composite.

H5.b hypothesis: Apply DISTS-augmented composite ONLY for variant=all.
All other variants keep the original 0.4/0.3/0.3 composite.
...
METHOD_ID = "P1_120c_dists_all_and_all_no_mask"
SSIM_SIZE = 512
BATCH_SIZE = 16
DINO_SIZE = 224
...
USE_DISTS = variant in {"all", "all_no_mask"}  # H5.c: extend DISTS to all_no_mask too
