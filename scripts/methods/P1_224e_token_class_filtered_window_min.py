...
METHOD_ID = "P1_224e_token_class_filtered_window_min"
SSIM_SIZE = 512
BATCH_SIZE = 16
DINO_SIZE = 224
...
def _fuse(prod_cc, page_name):
    ...
    Entropy SOURCE per-variant routed via SOURCE_ROUTING:
      ...
      - formula: window-MIN of mean-Shannon-confidence (D215.l)
      - all/all_no_mask: token-class-filtered rolling-K window-MIN (D224.e)
