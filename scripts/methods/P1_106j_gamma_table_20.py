...
METHOD_ID = "P1_106j_gamma_table_20"
SSIM_SIZE = 512
BATCH_SIZE = 16
DINO_SIZE = 224
...
GAMMA_DIQA = {
    "table": 0.2,    # D106.j: sweep from D106.d γ=0.10; weights = 0.8 prod_cc + 0.2 D106
    "all": 0.0,
    "text": 0.0,
    "formula": 0.4,  # D106.f best: 0.3 prod_cc + 0.3 entropy + 0.4 D106 (held)
    "all_no_mask": 0.0,
}[variant]
DIQA_EPS = 1e-6
