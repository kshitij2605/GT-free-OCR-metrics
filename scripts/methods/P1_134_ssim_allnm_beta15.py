...
METHOD_ID = "P1_134_ssim_allnm_beta15"
SSIM_SIZE = 512
BATCH_SIZE = 16
DINO_SIZE = 224
...
BETA_TABLE_CELL = {
    ...
    "text": 0.0,
    "formula": 0.0,
    "all_no_mask": 0.15,  # D134: all_no_mask SSIM β sweep 0.10→0.15
}[variant]
...
BETA_SSIM = {
    "table": 0.10,     # D132: table SSIM β sweep 0.05→0.10 (D128 KEEP confirmed axis)
    "all": 0.15,
