...
METHOD_ID = "P1_127_ssim_all_beta20"
SSIM_SIZE = 512
BATCH_SIZE = 16
DINO_SIZE = 224
...
BETA_SSIM = {
    "table": 0.0,
    "all": 0.20,         # D127: sweep from 0.15→0.20 for all variant
    "text": 0.15,        # D122 KEEP: text β=0.15 (unchanged)
    "formula": 0.05,     # D123 KEEP: formula β=0.05 (unchanged)
    "all_no_mask": 0.15, # D127: sweep from 0.10→0.15 for all_no_mask
}[variant]
